...
![Dark trading-desk / multi-panel feed UI reference](./docs/design/trading-desk-reference-01.png)

_Dark trading-desk / multi-panel feed UI reference_

![Prelogin / marketing landing page (first viewport)](./docs/design/prelogin-reference-01.png)

_Prelogin / marketing landing — brand, hero, CTA, and feed preview blotter_

![Prelogin landing target design (keep top; add sections below)](./docs/design/prelogin-target-design-01.png)
...
![Prelogin hero + dark feed preview (variant 01)](./docs/design/prelogin-target-hero-dark-feed-01.png)
