...
description: >-
  ...
  every push that touches the schema.
---
...
6. Stage DB-TABLES.md with schema (+ drizzle migrations) before commit / push
```
...
- [ ] `DB-TABLES.md` updated (table list + count + one-liners)
