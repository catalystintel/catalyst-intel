  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        overlayClassName="z-[100] bg-[var(--desk-scrim)] supports-backdrop-filter:backdrop-blur-sm"
        className={cn(
          "desk-arial z-[110] flex max-h-[min(92vh,920px)] w-[min(100%-1.5rem,52rem)] max-w-none translate-y-[-50%] flex-col gap-0 overflow-hidden rounded-xl border border-[var(--desk-border-strong)] bg-[var(--desk-panel)] p-0 text-[var(--desk-text)] shadow-[0_28px_90px_var(--desk-panel-shadow)] ring-1 ring-[var(--desk-live)]/30 sm:max-w-none",
        )}
      >
