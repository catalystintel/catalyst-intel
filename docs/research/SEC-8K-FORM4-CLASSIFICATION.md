...
Titles follow ground-rule patterns already used for earnings / FDA / halts:

- `Earnings Report Qn - {Company}`
- `Form 4 Insider Buy - {Company}`
- `{8-K item label} - {Company}`
...
| ---- | ---------------------------------------------- | ----------------------------------------- | ---------------- | --------------------------------------- |
| 1.01 | Entry into material agreement                  | `Material Agreement - {Co}`               | **Catalyst**     | Contracts, partnerships                 |
| 1.02 | Termination of material agreement              | `Agreement Terminated - {Co}`             | **Catalyst**     |                                         |
| 1.03 | Bankruptcy / receivership                      | `Bankruptcy / Receivership - {Co}`        | **Catalyst**     | High urgency                            |
...
| 3.01 | Notice of delisting / failure to satisfy       | `Delisting Risk - {Co}`                   | **Catalyst**     |                                         |
...
| 5.02 | Departure/election of directors; officer appt. | `Officer / Director Change - {Co}`        | **Catalyst**     | C-suite moves matter                    |
...
| Item 1.01 only (+ 9.01) | `Material Agreement - PEDEVCO CORP`             |
